...
describe('Collapse', () => {
    ...
    it('接受 selected 属性', (done) => {
        ...
        Vue.component('pf-collapse', Collapse)
        Vue.component('pf-collapse-item', CollapseItem)
        const div = document.createElement('div')
        document.body.appendChild(div)
        div.innerHTML = `
        <pf-collapse :selected="xxx">
          <pf-collapse-item title="标题1" name="1"><span id="content-1">1</span></pf-collapse-item>
          <pf-collapse-item title="标题2" name="2"><span id="content-2">2</span></pf-collapse-item>
          <pf-collapse-item title="标题3" name="3"><span id="content-3">3</span></pf-collapse-item>
        </pf-collapse>
    `
        const vm = new Vue({
            el: div,
    ...
    it('接受 single 属性', (done) => {
        ...
        document.body.appendChild(div)
        div.innerHTML = `
        <pf-collapse :selected.sync="xxx" single>
          <pf-collapse-item title="标题1" name="1"><span id="content-1">1</span></pf-collapse-item>
          <pf-collapse-item title="标题2" name="2"><span id="content-2">2</span></pf-collapse-item>
          <pf-collapse-item title="标题3" name="3"><span id="content-3">3</span></pf-collapse-item>
        </pf-collapse>
